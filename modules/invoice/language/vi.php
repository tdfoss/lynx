...
$lang_module['paytime'] = 'Thời gian xác nhận thanh toán';
...
$lang_module['new_invoice_by_workforce'] = '<strong>%s</strong> vừa tạo hóa đơn <strong>%s</strong>';
$lang_module['confirm_invoice_by_workforce'] = '<strong>%s</strong> vừa xác nhận thanh toán hóa đơn <strong>%s</strong>';
...
$lang_module['money_unit'] = 'Đơn vị tính';
$lang_module['score'] = 'Điểm tích lũy';
$lang_module['score_history'] = 'Lịch sử điểm tích lũy';
$lang_module['score_history_of'] = 'Lịch sử điểm tích lũy của %s';
$lang_module['transaction_type'] = 'Hình thức giao dịch';
$lang_module['transaction_type_1'] = 'Tiền mặt';
$lang_module['transaction_type_2'] = 'Điểm tích lũy';
$lang_module['score_note'] = '(Khách hàng sẽ bị trừ <strong>%s</strong> điểm tích lũy cho số tiền này)';
$lang_module['score_customer_note'] = 'Điểm tích lũy của khách hàng <strong>%s</strong> hiện tại là <strong>%s</strong> điểm (%s VNĐ)';
$lang_module['score_error'] = 'Điểm tích lũy không đủ để thanh toán';
$lang_module['unit_price'] = 'Đơn giá';
$lang_module['logs_transaction_add'] = '<strong>%s</strong> đã thêm giao dịch cho hóa đơn <strong>[#%s] %s</strong> với số tiền <strong>%s</strong>';
...
$lang_module['money'] = 'Thành tiền';
$lang_module['invoiceid'] = 'Hóa đơn';
$lang_module['useradd'] = 'Người thêm';
