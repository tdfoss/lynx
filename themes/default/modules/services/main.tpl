            ...
            <tbody>
                ...
                <tr onclick="nv_table_row_click(event, '{VIEW.link_view}', false);">
                    ...
                    <td class="text-center">
                        <input type="checkbox" name="active" id="change_status_{VIEW.id}" value="{VIEW.id}" {CHECK} onclick="nv_change_status({VIEW.id});" />
                    </td>
                    <td class="text-center">
                        <!-- BEGIN: invoice -->
                        <a class="btn btn-default btn-xs" href="{VIEW.link_invoice}" title="{LANG.invoice_view}"><i class="fa fa-file-o">&nbsp;</i></a>&nbsp;
                        <!-- END: invoice -->
                        <a class="btn btn-default btn-xs" href="{VIEW.link_edit}" title="{LANG.edit}"><i class="fa fa-edit">&nbsp;</i></a>&nbsp;<a href="{VIEW.link_delete}" class="btn btn-default btn-xs" title="{LANG.delete}" onclick="return confirm(nv_is_del_confirm[0]);"><em class="fa fa-trash-o">&nbsp;</em></a>
                    </td>
                </tr>
                <!-- END: loop -->
            </tbody>
