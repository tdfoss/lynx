...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <ul class="pull-right list-inline">
            <li><a href="{ROWS.link_add}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-original-title="{LANG.add_service}"><em class="fa fa-plus-square">&nbsp;</em>{LANG.add_service}</a></li>
