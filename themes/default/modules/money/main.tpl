    ...
    <form action="{ACTION}" method="get">
        ...
        <div class="row">
            <div class="col-xs-24 col-md-4">
                <div class="form-group">
                    <div class="input-group">
                        <input class="form-control datepicker" value="{SEARCH.from}" type="text" name="from" placeholder="{LANG.date_from}" /> <span class="input-group-btn">
            ...
            <div class="col-xs-24 col-md-4">
                <div class="form-group">
                    <div class="input-group">
                        <input class="form-control datepicker" value="{SEARCH.to}" type="text" name="to" placeholder="{LANG.date_to}" /> <span class="input-group-btn">
                            <button class="btn btn-default" type="button">
                                <em class="fa fa-calendar fa-fix">&nbsp;</em>
                            </button>
                        </span>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <!-- BEGIN: admin --> <i class="fa fa-edit">&nbsp;</i> <a href="{VIEW.link_edit}">{LANG.edit}</a> - <em class="fa fa-trash-o">&nbsp;</em> <a href="{VIEW.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);">{LANG.delete}</a> <!-- END: admin -->
                    </td>
                </tr>
                <!-- END: loop -->
            </tbody>
