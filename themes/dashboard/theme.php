...
function nv_site_theme($contents, $full = true)
{
    ...
    if ($global_config['current_theme_type'] == 'r') {
        ...
        $html_links[] = array(
            'rel' => 'StyleSheet',
            'href' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/css/AdminLTE.min.css'
        );
        $html_links[] = array(
            'rel' => 'StyleSheet',
            'href' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/css/_all-skins.min.css'
        );
        $html_links[] = array(
            'rel' => 'StyleSheet',
        ...
        $html_links[] = array(
            'rel' => 'StyleSheet',
            'href' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/css/dashboard.css'
        );
        $html_links[] = array(
            'rel' => 'StyleSheet',
