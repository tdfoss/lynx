...
function(a) {
    ...
    h.prototype.init = function() {
        ...
        b && b.preventDefault(), this.fix(), a(e.sidebar).is(e.open) || a(".menu-hover").is(e.open) ? this.collapse() : this.expand()
    }, h.prototype.expand = function() {
        this.options.slide ? a(e.sidebar).addClass(f.open) : a(".menu-hover").addClass(f.open), a(this.element).trigger(a.Event(g.expanded))
    }, h.prototype.collapse = function() {
...
function(a) {
    ...
    g.prototype.activate = function() {
        this.fix(), this.fixSidebar(), a(".menu-hover").removeClass(f.holdTransition), this.options.resetHeight && a("body, html, " + e.wrapper).css({
            height: "auto",
            "min-height": "100%"
        ...
        if (a(".menu-hover").hasClass(f.fixed)) a(e.contentWrapper).css("min-height", g - b);
        else {
            var i;
        ...
        if (!a(".menu-hover").hasClass(f.fixed)) return void(void 0 !== a.fn.slimScroll && a(e.sidebar).slimScroll({
            destroy: !0
        }).height("auto"));
...
function(a) {
    ...
    h.prototype.init = function() {
        (this.options.expandOnHover || a(".menu-hover").is(e.mini + e.layoutFixed)) && (this.expandOnHover(), a(".menu-hover").addClass(f.expandFeature)), a(e.contentWrapper).click(function() {
            a(window).width() <= this.options.collapseScreenSize && a(".menu-hover").hasClass(f.open) && this.close()
        }.bind(this)), a(e.searchInput).click(function(a) {
            a.stopPropagation()
        })
    }, h.prototype.toggle = function() {
        var b = a(window).width(),
            c = !a(".menu-hover").hasClass(f.collapsed);
        b <= this.options.collapseScreenSize && (c = a(".menu-hover").hasClass(f.open)), c ? this.close() : this.open()
    }, h.prototype.open = function() {
        a(window).width() > this.options.collapseScreenSize ? a(".menu-hover").removeClass(f.collapsed).trigger(a.Event(g.expanded)) : a(".menu-hover").addClass(f.open).trigger(a.Event(g.expanded))
    }, h.prototype.close = function() {
        a(window).width() > this.options.collapseScreenSize ? a(".menu-hover").addClass(f.collapsed).trigger(a.Event(g.collapsed)) : a(".menu-hover").removeClass(f.open + " " + f.collapsed).trigger(a.Event(g.collapsed))
    }, h.prototype.expandOnHover = function() {
        a(e.mainSidebar).hover(function() {
            a(".menu-hover").is(e.mini + e.collapsed) && a(window).width() > this.options.collapseScreenSize && this.expand()
        }.bind(this), function() {
            a(".menu-hover").is(e.expanded) && this.collapse()
        }.bind(this))
    }, h.prototype.expand = function() {
        setTimeout(function() {
            a(".menu-hover").removeClass(f.collapsed).addClass(f.expanded)
        }, this.options.expandTransitionDelay)
    }, h.prototype.collapse = function() {
        setTimeout(function() {
            a(".menu-hover").removeClass(f.expanded).addClass(f.collapsed)
        }, this.options.expandTransitionDelay)
    };
    var i = a.fn.pushMenu;
