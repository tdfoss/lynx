...
$(function () {
    ...
    $demoSettings.append(
        ...
        + 'Chuyển từ nền tối, sang nền sáng.'
        + '</label>'
        + '</div>'
    )
    ...
    // Dark sidebar skins
    var $skinBlue =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-blue" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '</a>'
                + '<p class="text-center m-t10">Xanh dương</p>')
    ...
    var $skinBlueLight =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-blue-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '</a>'
                + '<p class="text-center m-t10" style="font-size: 12px">Xanh da trời</p>')
       ...
       var $skinGreen =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-green" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #222d32"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10">Green</p>')
     ...
     var $skinGreenLight =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-green-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #f9fafc"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10" style="font-size: 12px">Xanh lá</p>')
    ...
    var $skinRed =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-red" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #222d32"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10">màu đỏ</p>')
      ...
      var $skinRedLight =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-red-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #f9fafc"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10" style="font-size: 12px">Đỏ nhạt </p>')
    $skinsList.append($skinRedLight)
        ...
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-purple" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #222d32"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10">màu tím</p>')
       ...
       var $skinPurpleLight =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-purple-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #f9fafc"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10" style="font-size: 12px">Tím mơ</p>')
    $skinsList.append($skinPurpleLight)
        ...
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-yellow" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #222d32"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10">màu vàng</p>')
    $skinsList.append($skinYellow)
        ...
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-yellow-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #f9fafc"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10" style="font-size: 12px">Vàng nhạt</p>')
    ...
    var $skinBlack =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-black" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '</a>'
                + '<p class="text-center m-t10">Màu đen</p>')
    ...
    var $skinBlackLight =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-black-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #f9fafc"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10" style="font-size: 12px">Đen xám</p>')
    ...
    var $skinPink =
        $('<li />', {style: 'float:left; width: 33.333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-pink" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                + '<div><span style="display:block; width: 20%; float: left; height: 10px;" class="bg-pink-active"></span><span class="bg-pink" style="display:block; width: 80%; float: left; height: 10px;"></span></div>'
                + '<div><span style="display:block; width: 20%; float: left; height: 50px; background: #f9fafc"></span><span style="display:block; width: 80%; float: left; height: 50px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center m-t10" style="font-size: 12px">Màu hồng</p>')
    $skinsList.append($skinPink)

    $demoSettings.append('<h4 class="control-sidebar-heading">Tông màu chính</h4>')
