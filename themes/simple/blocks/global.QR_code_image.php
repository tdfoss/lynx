...
if( ! nv_function_exists( 'nv_block_qr_code' ) )
{
	...
	function nv_block_qr_code( $block_config )
	{
        ...
        if ( file_exists( NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.QR_code_image.tpl' ) )
        {
            $block_theme = $global_config['module_theme'];
        }
        elseif ( file_exists( NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.QR_code_image.tpl' ) )
        {
		...
		$block_config['qr_src'] = NV_BASE_SITEURL . "index.php?second=qr&u=" . urlencode( $client_info['selfurl'] ) . "&l=" . $block_config["level"] . "&ppp=" . $block_config["pixel_per_point"] . "&of=" . $block_config["outer_frame"];

        $xtpl = new XTemplate( 'global.QR_code_image.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks' );
