	...
	<form id="filter-form" method="get" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" class="clearfix">
		<div class="row">
			...
			<div class="col-xs-6 col-md-2">
				<div class="form-group">
					<div class="input-group">
						<input class="form-control" value="{DATA_SEARCH.from}" type="text" id="from" name="from" readonly="readonly" placeholder="{LANG.filter_from}" /> <span class="input-group-btn">
			...
			<div class="col-xs-6 col-md-2">
				<div class="form-group">
					<div class="input-group">
						<input class="form-control" value="{DATA_SEARCH.to}" type="text" id="to" name="to" readonly="readonly" placeholder="{LANG.filter_to}" /> <span class="input-group-btn">
			...
			<div class="col-xs-12 col-md-12 text-center">
				<div class="form-group">
					<input type="button" name="action" value="{LANG.filter_action}" class="btn btn-primary" /> <input type="button" name="cancel" value="{LANG.filter_cancel}" onclick="window.location='{URL_CANCEL}';" {DISABLE} class="btn btn-danger" /> <input type="button" name="clear" value="{LANG.filter_clear}" class="btn btn-default" />
				</div>
			</div>
		</div>
	</form>
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tfoot>
					<tr>
						<td colspan="8">
							<!-- BEGIN: foot_delete --> <input type="button" value="{GLANG.delete}" id="delall" class="btn btn-primary" /> <input type="button" value="{LANG.log_empty}" id="logempty" class="btn btn-primary" /> <!-- END: foot_delete --> <!-- BEGIN: generate_page -->
							<div class="text-center">{GENERATE_PAGE}</div> <!-- END: generate_page -->
						</td>
					</tr>
				</tfoot>
			</table>
